...
export function ClientListPage(props: ClientListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getClients({
        relations: ['user', 'invoice.count', 'payment_history.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('invoice', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('payment_history', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'payment_history',
          header: 'Payment History',
          accessorKey: 'payment_history',
          cell: ({ row: { original: record } }: any) => record?._count?.payment_history,
        }
      : null,
