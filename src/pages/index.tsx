...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Billing Application for my small company`}</title>

        <meta
          name="description"
          content="Experience hassle-free invoicing with Billing Application for my small company - your partner in effortless financial management."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxiaWxsaW5nfGVufDB8fHx8MTY5NDI3OTQ0OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Billing Application for my small company`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience hassle-free invoicing with Billing Application for my small company - your partner in effortless financial management.`}
            </Text>
            <Box
